	...
	<p></p>
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p style="text-align: justify;">Visit the admission and registration office to complete the admission process.</p>
        </div>
      </div>
      <div class="step">
      ...
      <div class="step">
        ...
        <div class="step-content">
          ...
          <p style="text-align: justify;">Track the progress of your application in (ODMS) using your ministry number, and proceed with next steps.</p>
        </div>
      </div>
      <div class="step">
