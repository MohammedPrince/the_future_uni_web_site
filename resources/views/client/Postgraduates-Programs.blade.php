...
@section('main-client-content')
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span style="color: #d1291f;">Postgraduates Programs</span>
        </div>
    </div>
                    ...
                    <div class="post-content">
                        ...
                        <blockquote class="text-center" style="background-color: whitesmoke;">
                            <span style="font-size: 18px;">
                                ...
                                inspired by the excellent management of faculty members.
                                The Graduate Programs are supported by academic and research curriculum that are recognized
