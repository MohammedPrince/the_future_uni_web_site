...
@section('main-client-content')
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span style="color: #fb8b24;">Fu Students Gallery</span>
        </div>
    </div>
                    ...
                    <div class="post-content">
                        ...
                        <blockquote class="text-center" style="background-color: whitesmoke;">
                            <span style="font-size: 18px;">
                                The Future Univesity Students Activities Gallery.
                            </span>
                        </blockquote>
                        </p>
                        ...
                        <div class="hr-sect new4"><span>FU Open Days Gallery</span></div><p></p>

                        <div class="tab">
                            <button class="tablinks" onclick="openTab(event, 'FU-OpendDay01')">1st Open Day</button>
                            <button class="tablinks" onclick="openTab(event, 'FU-OpendDay02')">2nd Open Day</button>
                            <button class="tablinks" onclick="openTab(event, 'Fu-OpendDay03')">3rd Open Day</button>
                            <button class="tablinks" onclick="openTab(event, 'Fu-OpendDay04')">4th Open Day</button>
                            <button class="tablinks" onclick="openTab(event, 'Fu-OpendDay05')">5th Open Day</button>
                        </div>

                        <div id="FU-OpendDay01" class="tabcontent">
                        ...
                        <div id="FU-OpendDay02" class="tabcontent">
                        ...
                        <div id="Fu-OpendDay05" class="tabcontent">
