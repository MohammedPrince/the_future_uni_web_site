                                            ...
                                            <table cellspacing="0" cellpadding="20">
                                                <tr>
                                                    <td width="10%">
                                                        ...
                                                        @else
                                                            <div class="circle">
                                                                <img src="{{ asset('/storage/app/public/staff_imgs/' . $staff_info_cv->cv_image) }}"
                                                                    alt="Image">
                                                            </div>
                                                        @endif
                                                ...
                                                @if ($staff_info_cv?->work_experience != '')
                                                    <tr>
                                                        <td style="vertical-align: top; text-align: left;">Work Experience
                                                        </td>
                                                        <td style="vertical-align: top;">
                                                ...
                                                @if ($staff_info_cv?->teaching_and_supervision != '')
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: top; text-align: left;">Teaching and
                                                            Supervision</td>
                                                        <td style="vertical-align: top;">
                                                ...
                                                @if ($staff_info_cv?->academic_recognition_and_leadership != '')
                                                    <tr>
                                                        <td style="vertical-align: top; text-align: left;">Academic
                                                            Recognition</td>
                                                        <td style="vertical-align: top;">
