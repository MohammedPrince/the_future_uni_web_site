                            ...
                            <div class="container text-center">
                                <div class="tab">
                                    ...
                                    <button class="tablinks"
                                        ...
                                        <button class="tablinks" onclick="openTab(event, 'Architecture')">Arts & Design</button>
                                    ...
                                    <button class="tablinks" onclick="openTab(event, 'Architecture')">Geoinformatics</button>
                                </div>
