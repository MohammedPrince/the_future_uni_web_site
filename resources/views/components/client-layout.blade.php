...
<body>
	...
	<header class="header-section">
		<div class="container">
			...
			<a href="Home" class="site-logo"><img src="{{asset('./public/client/img/fu_logo.png')}}" height="100px" width="100px" alt></a>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					<div class="about-widget">
						<img src="{{asset('./public/client/img/fu_logo.png')}}" alt="The Future University" width="80px" height="80px" loading="lazy">
